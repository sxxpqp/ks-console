...
import { Input, Columns, Column, Alert } from '@kube-design/components'
...
export default class ResourceLimit extends React.Component {
  ...
  static getValue(props) {
    ...
    return {
      requests: {
        ...
        gpu: cpuFormat(
          ResourceLimit.getDefaultRequestValue(props, 'gpu'),
          cpuUnit
        ),
      },
      limits: {
        ...
        gpu: cpuFormat(
          ResourceLimit.getDefaultLimitValue(props, 'gpu'),
          cpuUnit
        ),
      },
    }
  ...
  getCPUProps() {
    ...
    return {
      marks: [
        ...
        { value: 4, label: 4, weight: 3 },
        { value: 8, label: 8, weight: 4 },
        { value: 16, label: 16, weight: 8 },
        { value: 32, label: 32, weight: 8 },
        { value: 64, label: 64, weight: 2 },
  ...
  getDiskProps() {
    ...
    return {
      marks: [
        { value: 0, label: t('No Request'), weight: 2 },
        { value: 5, label: 5, weight: 2 },
        { value: 8, label: 8, weight: 2 },
        { value: 10, label: 10, weight: 2 },
        { value: 20, label: 20, weight: 2 },
        { value: 40, label: 40, weight: 2 },
  ...
  render() {
    ...
    return (
      <div className={styles.wrapper}>
        ...
        <div className={styles.sliderWrapper}>
          <div>GPU ({this.cpuUnit})</div>
          <Slider {...this.getCPUProps()} />
        </div>
        <div className={styles.sliderWrapper}>
          <div>存储 (GB)</div>
          <Slider {...this.getDiskProps()} />
        </div>
        <div className={styles.inputWrapper}>
          <Columns className="is-gapless">
            <Column className={styles.flex}>
          ...
          <Columns className="is-gapless">
            <Column className={styles.flex}>
              <div className={styles.title}>GPU</div>
              <div className={styles.inputGroup}>
                {/* <Icon name="cpu" size={48} /> */}
                <div
                  className={classnames(styles.input, {
            ...
            <Column className={styles.flex}>
              <div className={styles.title}>磁盘</div>
              <div className={styles.inputGroup}>
                {/* <Icon name="memory" size={48} /> */}
                <div
                  className={classnames(styles.input, {
